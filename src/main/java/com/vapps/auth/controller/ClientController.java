...
public class ClientController {
    ...
    public ResponseEntity<?> getAllClient(@PathVariable("userId") String userId, Principal principal,
        ...
        ClientControllerResponse clientResponse =
                new ClientControllerResponse(HttpStatus.OK.value(), "success", LocalDateTime.now(),
                        request.getServletPath(), clients);
    ...
    public ResponseEntity<?> getClient(@PathVariable("userId") String userId, @PathVariable("clientId") String clientId,
        ...
        SingleClientControllerResponse clientResponse =
                new SingleClientControllerResponse(HttpStatus.OK.value(), "success", LocalDateTime.now(),
                        request.getServletPath(), client);
    ...
    public ResponseEntity<?> updateClient(@PathVariable("userId") String userId,
            @PathVariable("clientId") String clientId, @RequestBody ClientDTO clientDetails, Principal principal)
            throws AppException {
    ...
    @GetMapping("{clientName}/exists")
    public ResponseEntity<?> isClientExistsWithName(@PathVariable("userId") String userId,
            @PathVariable String clientName, Principal principal) throws AppException {
        boolean isExists = clientService.isClientExistsByName(clientName);

        ClientExistsResponse response = new ClientExistsResponse();
        response.setMessage("Is client exists: " + isExists);
        response.setTimestamp(LocalDateTime.now());
